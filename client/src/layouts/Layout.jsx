          ...
          <div className="flex flex-wrap justify-between text-left mb-8">
            ...
            <div className="w-full md:w-1/4 mb-6 md:mb-0">
              ...
              <div className="flex space-x-4">
                ...
                {/* TikTok */}
                <a
                  href="https://www.tiktok.com/@somoshuizy_?_t=ZS-90k9C9F4Kll&_r=1"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="TikTok"
                >
                  ...
                  >
                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.55 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.05-4.84-.6-6.6-2.31C.48 18.2.015 15.69.285 13.3c.27-2.39 1.52-4.64 3.23-6.32.8-2.03 3.16-3.17 5.3-3.21v.01z" />
                  </svg>
                </a>
              </div>
            </div>
